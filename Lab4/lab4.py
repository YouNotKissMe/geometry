...
# arr = [[0, 0], [0, 4], [-4, 0], [5, 0], [0, -6], [1, 0]]
arr = [[0, 0], [10, 0],[10, 9], [9, 9],[9, 10], [0, 10]]
print('алгоритм Грехема', grahamscan(arr))
for i in grahamscan(arr):
    print(arr[i])

print('алгоритм Джарвиса', jarvismarch(arr))
